        ...
        <div class="content-wrapper" style="width: 80% !important;">
           <h3 class="text-primary mb-4">Agregar Actividades</h3>
			...
			<form id="referencia">  
				...
				<div class="row mb-2">
					<div class="col-lg-12">
						 <button type="button" class="btn btn-primary" onclick="formularioCrearActividad()">Crear Nueva</button>
                            <br />
                            <br />
                            
						<div class="card">
							<div class="card-block">
								<table id="table_actividades" class="display" cellspacing="0"></table>
							</div>
						</div>
					</div>                    
				</div>  
